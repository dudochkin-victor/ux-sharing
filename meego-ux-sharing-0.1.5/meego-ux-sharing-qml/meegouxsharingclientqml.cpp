...
//    qmlRegisterType<MeeGoUXSharingClientService>(uri, 0, 0, "MeeGoUXSharingClientService");
    qmlRegisterType<MeeGoUXSharingClientServiceModel>(uri, 0, 1, "MeeGoUXSharingClientServiceModel");
    qmlRegisterType<MeeGoUXSharingClientQmlObj>(uri, 0, 1, "MeeGoUXSharingClientQmlObj");
}
